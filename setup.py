...
setup(
    ...
    version="0.1.0",
    description="Collaboration with the social enterprise Community Shop to assess the impact of their model on their members' health",
    author="AHL",
    license="MIT",
)
